...
?>
<?php
$pageTitle = 'Prezentacje - Yti School';
$activePage = 'page_presentations.php';
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            <header class="content-header">
                ...
                <p style="color: var(--text-secondary); margin-top: 5px; font-size: 0.9rem;">Przeglądaj interaktywne slajdy lekcji (Klasa: <?= htmlspecialchars($student_class ?: 'Wszystkie') ?>)</p>
            </header>
            ...
            <?php if (empty($notes)): ?>
                <div class="empty-state-card">
                    ...
                    <h3>Brak dostępnych prezentacji</h3>
