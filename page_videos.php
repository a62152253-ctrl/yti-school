...
?>
<?php
$pageTitle = 'Wideo - Yti School';
$activePage = 'page_videos.php';
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            <header class="content-header">
                <h2>Wideo i Odtwarzacze</h2>
                <p style="color: var(--text-secondary); margin-top: 5px; font-size: 0.9rem;">Przeglądaj nagrania i interaktywne slajdy wideo (Klasa: <?= htmlspecialchars($student_class ?: 'Wszystkie') ?>)</p>
            </header>
            ...
            <?php if (empty($notes)): ?>
                <div class="glass-card" style="padding: 60px; text-align: center; color: var(--text-secondary);">
                    ...
                    <h3>Brak dostępnych materiałów wideo</h3>
                    <p style="margin-top: 10px;">Zajrzyj tu później lub zmień klasę w profilu.</p>
                </div>
            <?php else: ?>
