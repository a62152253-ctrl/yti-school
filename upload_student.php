...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && strcasecmp($_SERVER['HTTP_X_REQUESTED_WITH'] ?? '', 'XMLHttpRequest') === 0) {
    ...
    // Students can only upload free files!
    $access_type = 'free';
    $premium_price = 0.0;
...
?>
<?php
$pageTitle = 'Dodaj Materiały (Uczeń) - Yti School';
...
<?php require_once 'partials/topbar.php'; ?>
    <div class="app-container">
        ...
        <div class="glass-card" style="padding: 30px;">
            ...
            <form id="uploadForm" action="upload_student.php" method="POST" enctype="multipart/form-data">
                <?= csrfField() ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            uploadForm.addEventListener('submit', (e) => {
                ...
                xhr.open('POST', 'upload_student.php', true);
