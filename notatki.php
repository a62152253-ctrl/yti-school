...
<head>
    ...
    <title>Notatki i PDF - Yti School</title>
...
<body>
    ...
    <header class="yt-header">
        ...
        <div class="yt-header-center">
            <form action="notatki.php" method="GET" class="yt-search-form">
                <div class="yt-search-box autocomplete-container">
                    <input type="text" name="search" id="ytSearchInput" placeholder="Szukaj notatek..." value="<?= htmlspecialchars($search_query) ?>" autocomplete="off">
